                        ...
                        return (
                          <td key={p.id} style={{ padding: '6px 8px', textAlign: 'center' }}>
                            <input
                              ...
                              onBlur={(e) => { if (e.target.value !== String(val)) updatePlanLimit(p.id, row.key, e.target.value); e.target.style.border = '1px solid transparent'; e.target.style.background = 'transparent' }}
                              placeholder="—"
                              style={{
