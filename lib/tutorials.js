...
export const TUTORIALS = {
  ...
  products: {
    icon: '📦', title: 'Catálogo',
    purpose: 'A vitrine da sua loja dentro do WhatsApp. Cada produto aparece no catálogo oficial, com foto e preço — e os pedidos do carrinho chegam na sub-aba Pedidos.',
    ...
    automation: { intro: 'A loja funciona enquanto você dorme:', items: [
      ...
      'Cliente monta o carrinho → pedido organizado chega na sub-aba 🛍️ Pedidos.',
      'Pagamento aprovado → pedido marcado como Pago sozinho.',
    ] },
    features: [
    ...
    example: {
      ...
      after: 'O cliente monta o carrinho com as fotos, envia o pedido e ele chega organizado na sub-aba 🛍️ Pedidos desta aba.',
    },
    tip: 'A foto é o que mais influencia na venda: quadrada, bem iluminada, fundo limpo.',
  },

  agendamentos: {
    icon: '🗓️', title: 'Agendamentos',
    purpose: 'A central dos agendamentos: serviços com taxa via PIX (confirmados sozinhos), horários de atendimento e sua Google Agenda — tudo em um só lugar.',
    ...
    features: [
      ...
      { icon: '⏰', title: 'Horários & Google Agenda', desc: 'Expediente, dias de funcionamento e sincronização com sua agenda pessoal — configurados aqui mesmo.' },
    ...
    steps: [
      { title: 'Crie o serviço', desc: 'Na sub-aba 📅 Serviços: nome, duração (ex: 45 min) e taxa (ex: R$ 10).' },
    ...
    tip: 'Conecte sua Google Agenda na sub-aba ⏰ Horários & Google Agenda: o bot nunca marca por cima de um compromisso seu.',
  },
  ...
  'whatsapp-setup': {
    ...
    tip: 'Número novo de chip (nunca logado num app) conecta na hora. Número que estava no app precisa ser liberado primeiro — e ao migrar o número sai dos grupos (regra da Meta), anote e peça readmissão depois.',
  },
