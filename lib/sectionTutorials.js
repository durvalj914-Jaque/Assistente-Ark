...
export const SECTION_TUTORIALS = {
  ...
  'whatsapp-setup:automatica': {
    ...
    steps: [
      { title: 'Nome da empresa + número com DDD', desc: 'O número precisa estar ativo num WhatsApp (pode ser do celular da loja).' },
  ...
  'whatsapp-setup:manual': {
    ...
    automation: { intro: 'A equipe entra no processo só quando necessário:', items: [
      'Verificamos o número e o compatibilidade com a API oficial.',
